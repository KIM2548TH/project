...
Y = datas.iloc[:23, 9].dropna().values
...
plt.show()
joblib.dump(lin_poly, "/home/kimbiaw/project/funlab/AImodels/bangkok/model/polynomial_living_regression_model_bangkok.pkl")
print("โมเดล Polynomial Regression ถูกบันทึกเรียบร้อยแล้ว!")

# บันทึก PolynomialFeatures
# joblib.dump(poly, "/home/kimbiaw/project/funlab/AImodels/bangkok/model/polynomial_living_features_living_bangkok.pkl")

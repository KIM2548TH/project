...
plt.show()
joblib.dump(lin_poly, "/home/kimbiaw/project/funlab/AImodels/bangkok/model/polynomial_food_regression_model_bangkok.pkl")
print("โมเดล Polynomial Regression ถูกบันทึกเรียบร้อยแล้ว!")

# บันทึก PolynomialFeatures
# joblib.dump(poly, "/home/kimbiaw/project/funlab/AImodels/bangkok/model/polynomial_food_features_sungkha_bangkok.pkl")

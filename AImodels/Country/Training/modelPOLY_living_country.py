...
Y = datas.iloc[:23, 1].dropna().values
...
plt.show()
joblib.dump(lin_poly, "/home/kimbiaw/project/funlab/AImodels/Country/model/polynomial_living_regression_model_country.pkl")
print("โมเดล Polynomial Regression ถูกบันทึกเรียบร้อยแล้ว!")

# บันทึก PolynomialFeatures
joblib.dump(poly, "/home/kimbiaw/project/funlab/AImodels/Country/model/polynomial_features.pkl")

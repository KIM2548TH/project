...
Y = datas.iloc[:23, 4].dropna().values
...
plt.show()
joblib.dump(lin_poly, "/home/kimbiaw/project/funlab/AImodels/Country/model/polynomial_walk_regression_model_country.pkl")
print("โมเดล Polynomial Regression ถูกบันทึกเรียบร้อยแล้ว!")

# บันทึก PolynomialFeatures
# joblib.dump(poly, "/home/kimbiaw/project/funlab/AImodels/bangkok/model/polynomial_features_walk_bangkok.pkl")

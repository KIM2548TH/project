...
plt.show()
joblib.dump(lin_poly, "/home/kimbiaw/project/funlab/AImodels/Country/modelpolynomial_food_regression_model_country.pkl")
print("โมเดล Polynomial Regression ถูกบันทึกเรียบร้อยแล้ว!")

# บันทึก PolynomialFeatures
# joblib.dump(poly, "/home/kimbiaw/project/funlab/AImodels/bangkok/model/polynomial_food_features_country_bangkok.pkl")

...
url = "/home/kimbiaw/project/funlab/AImodels/sungkha/22222(22222).csv"
...
plt.show()
joblib.dump(lin_poly, "polynomial_living_regression_model_living.pkl")
print("โมเดล Polynomial Regression ถูกบันทึกเรียบร้อยแล้ว!")

# บันทึก PolynomialFeatures
joblib.dump(poly, "polynomial_living_features_living.pkl")

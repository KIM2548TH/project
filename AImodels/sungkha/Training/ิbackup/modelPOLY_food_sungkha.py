...
url = "/home/kimbiaw/project/funlab/AImodels/sungkha/Training/province.csv"
datas = pd.read_csv(url)

print(datas)
X = datas.iloc[:23, 0].values.reshape(-1, 1)
X_pre = datas.iloc[::, 0].values.reshape(-1, 1)
Y = datas.iloc[:23, 10].dropna().values
...
plt.show()
joblib.dump(lin_poly, "/home/kimbiaw/project/funlab/AImodels/sungkha/model/polynomial_food_regression_model_sungkha.pkl")
print("โมเดล Polynomial Regression ถูกบันทึกเรียบร้อยแล้ว!")

# บันทึก PolynomialFeatures
joblib.dump(poly, "/home/kimbiaw/project/funlab/AImodels/sungkha/model/polynomial_food_features_sungkha.pkl")

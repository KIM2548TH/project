...
plt.show()
joblib.dump(lin_poly, "/home/kimbiaw/project/funlab/AImodels/nakhon/model/polynomial_walk_regression_model_nakhon.pkl")
print("โมเดล Polynomial Regression ถูกบันทึกเรียบร้อยแล้ว!")

# บันทึก PolynomialFeatures
# joblib.dump(poly, "/home/kimbiaw/project/funlab/AImodels/nakhon/model/polynomial_features_walk_nakhon.pkl")
